...
create_bind(vars.kbShowSidebar, hl.dsp.global("orbit:sidebar"))
create_bind(vars.kbClearNotifs, hl.dsp.global("orbit:clearNotifs"), locked)
...
for i = 1, 10 do
    ...
    create_bind(extend_keybind(vars.kbGoToWs, key), wsaction("focus", "", i))
    create_bind(extend_keybind(vars.kbMoveWinToWs, key), wsaction("move", "", i))
    create_bind(extend_keybind(vars.kbGoToWsGroup, key), wsaction("focus", "group", i))
    create_bind(extend_keybind(vars.kbMoveWinToWsGroup, key), wsaction("move", "group", i))
end
...
create_bind(vars.kbWindowDecreaseWidth, resize_active_window(-10, 0), repeating)
create_bind(vars.kbWindowIncreaseWidth, resize_active_window(10, 0), repeating)
create_bind(vars.kbWindowDecreaseHeight, resize_active_window(0, -10), repeating)
create_bind(vars.kbWindowIncreaseHeight, resize_active_window(0, 10), repeating)
...
-- Special workspace toggles (managed by orbit-cli)
create_bind(vars.kbSpecialWs, hl.dsp.exec_cmd("orbit toggle specialws"))
create_bind(vars.kbSystemMonitorWs, hl.dsp.exec_cmd("orbit toggle sysmon"))
create_bind(vars.kbMusicWs, hl.dsp.exec_cmd("orbit toggle music"))
create_bind(vars.kbCommunicationWs, hl.dsp.exec_cmd("orbit toggle communication"))
create_bind(vars.kbTodoWs, hl.dsp.exec_cmd("orbit toggle todo"))
...
-- Utilities
create_bind(vars.kbScreenshot, hl.dsp.exec_cmd("orbit screenshot"), locked)
create_bind(vars.kbScreenshotFreeze, hl.dsp.global("orbit:screenshotFreeze"))
create_bind(vars.kbScreenshotRegion, hl.dsp.global("orbit:screenshot"))
create_bind(vars.kbRecord, hl.dsp.exec_cmd("orbit record"))
create_bind(vars.kbRecordSound, hl.dsp.exec_cmd("orbit record -s"))
create_bind(vars.kbRecordRegion, hl.dsp.exec_cmd("orbit record -r"))
create_bind(vars.kbColorPicker, hl.dsp.exec_cmd("hyprpicker -a"))

-- Brightness
create_bind("XF86MonBrightnessUp", hl.dsp.global("orbit:brightnessUp"), locked)
create_bind("XF86MonBrightnessDown", hl.dsp.global("orbit:brightnessDown"), locked)

-- Media
create_bind({ vars.kbMediaToggle, "XF86AudioPlay", "XF86AudioPause" }, hl.dsp.global("orbit:mediaToggle"), locked)
create_bind({ vars.kbMediaNext, "XF86AudioNext" }, hl.dsp.global("orbit:mediaNext"), locked)
create_bind({ vars.kbMediaPrev, "XF86AudioPrev" }, hl.dsp.global("orbit:mediaPrev"), locked)
create_bind({ vars.kbMediaStop, "XF86AudioStop" }, hl.dsp.global("orbit:mediaStop"), locked)
...
create_bind(vars.kbClipboard, hl.dsp.global("orbit:clipboard"))
create_bind(vars.kbClipboardDel, hl.dsp.exec_cmd("pkill fuzzel || orbit clipboard -d"))
create_bind(vars.kbEmoji, hl.dsp.exec_cmd("pkill fuzzel || orbit emoji -p"))
