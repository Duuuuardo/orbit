...
-- Orbit shell
hl.layer_rule({ match = { namespace = "orbit-(border-exclusion|area-picker)" }, no_anim = true })
hl.layer_rule({ match = { namespace = "orbit-(drawers|background)" }, animation = "fade" })