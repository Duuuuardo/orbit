...
class Lyrics : public QObject {
    ...
    Q_PROPERTY(orbit::config::LyricsBackend::Enum backend READ backend NOTIFY backendChanged)
    Q_PROPERTY(orbit::config::LyricsBackend::Enum preferredBackend READ preferredBackend WRITE setPreferredBackend
            NOTIFY preferredBackendChanged)
    Q_PROPERTY(
        QList<orbit::services::LyricCandidate> lyricCandidates READ lyricCandidates NOTIFY lyricCandidatesChanged)
    Q_PROPERTY(orbit::services::LyricCandidate selectedCandidate READ selectedCandidate WRITE setSelectedCandidate
