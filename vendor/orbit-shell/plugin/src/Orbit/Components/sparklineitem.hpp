...
class SparklineItem : public QQuickPaintedItem {
    ...
    Q_PROPERTY(orbit::CircularBuffer* line1 READ line1 WRITE setLine1 NOTIFY line1Changed)
    Q_PROPERTY(orbit::CircularBuffer* line2 READ line2 WRITE setLine2 NOTIFY line2Changed)
