...
class BlobRect : public BlobShape {
    ...
    Q_PROPERTY(QQmlListProperty<orbit::blobs::BlobRect> exclude READ exclude NOTIFY excludeChanged)
    Q_PROPERTY(
        QQmlListProperty<orbit::blobs::BlobRect> excludeCorners READ excludeCorners NOTIFY excludeCornersChanged)
