...
StyledRect {
    ...
    clip: true
    readonly property real pillHeight: Tokens.sizes.bar.innerWidth - Tokens.padding.small
    readonly property real pillWidth: Math.max(size, pillHeight)
    x: offset + mask.x - (pillWidth - size) / 2
