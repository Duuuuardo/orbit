...
from orbit.utils.paths import compute_hash, scheme_cache_dir, wallpaper_thumbnail_path
...
def get_score_for_image(image: Path | str, cache_base: Path):
    ...
    from orbit.utils.material.score import score
...
def get_colours_for_image(image: Path | str = wallpaper_thumbnail_path, scheme=None) -> dict[str, str]:
    ...
    from orbit.utils.material.generator import gen_scheme
