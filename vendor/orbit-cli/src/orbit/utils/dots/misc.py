...
from orbit.utils.dots.packages import PackageInstaller
from orbit.utils.dots.source import DotsSource
from orbit.utils.io import info, log, warn
from orbit.utils.paths import dots_dir
...
def run_hooks(manifest: Manifest, kind: str) -> None:
    ...
    env = {**os.environ, "ORBIT_DOTS": str(dots_dir)}
    for hook in hooks:
