...
c_config_dir: Path = config_dir / "orbit"
c_data_dir: Path = data_dir / "orbit"
c_state_dir: Path = state_dir / "orbit"
c_cache_dir: Path = cache_dir / "orbit"
...
wallpapers_dir: Path = Path(os.getenv("ORBIT_WALLPAPERS_DIR", pictures_dir / "Wallpapers"))
...
screenshots_dir: Path = Path(os.getenv("ORBIT_SCREENSHOTS_DIR", pictures_dir / "Screenshots"))
screenshots_cache_dir: Path = c_cache_dir / "screenshots"

recordings_dir: Path = Path(os.getenv("ORBIT_RECORDINGS_DIR", videos_dir / "Recordings"))
