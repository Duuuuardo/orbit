...
from orbit.utils.dots.diff import Changeset
...
from orbit.utils.dots.packages import PackageError, PackageInstaller
from orbit.utils.dots.source import DotsSource, SourceError
from orbit.utils.dots.state import DotsState
from orbit.utils.io import disable_input, fatal, info, log, prompt_selection, warn
...
class Command:
    ...
    def run(self) -> None:
        ...
        if state.applied_rev is None:
            fatal("dots not installed yet. Run `orbit install` first.")
