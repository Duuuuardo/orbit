...
from orbit.utils.dots.manifest import Manifest
from orbit.utils.dots.packages import AUR_HELPERS
from orbit.utils.dots.source import DotsSource
from orbit.utils.io import warn
from orbit.utils.paths import wallpapers_dir
from orbit.utils.scheme import get_scheme_names, scheme_variants
from orbit.utils.wallpaper import get_wallpaper

def parse_args() -> tuple[argparse.ArgumentParser, argparse.Namespace]:
    parser = argparse.ArgumentParser(prog="orbit", description="Main control script for the Orbit dotfiles")
    ...
    install_parser = command_parser.add_parser(
        "install",
        help="install the Orbit dotfiles",
    ...
    update_parser = command_parser.add_parser("update", help="update the Orbit dotfiles")
